...
## v2.26.02.003（2026-02-22 ~ 2026-02-25）
...
- 服务器管理页（`/admin/servers`）支持从列表直接打开节点详情页（`/stats/:sid`）。
- 桌面端在“编辑”旁新增“详情”按钮；移动端在“更多”菜单新增“查看详情”入口。
...
- 补充授权管理页面状态标签体验更新记录："已连接 / 离线模式 / 应急模式 / 检查中 / 连接异常"统一为同一套状态标签样式。
- 补充移动端与窄屏显示说明：状态文字在标签内显示更稳定，减少换行或看起来挤出标签的问题。
